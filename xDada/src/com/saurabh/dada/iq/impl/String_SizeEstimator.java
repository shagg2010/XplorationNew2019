...
public final class String_SizeEstimator {
	 ...
	 */
	private String_SizeEstimator() {
	}
	
	public static void main(String[] args){
		long output = estimatedSizeOf("Saurabh Yadav");
		System.out.println("String size in memory: "+output + " bytes.");
	}
	...
	static {
		...
		String jvmBit = IS_64_BIT_JVM?"64":"32";
		System.out.println("The current JVM is " + jvmBit + " bit.");
