...
public class GetNameFromUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public GetNameFromUserServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			bodyBuffer.append("<form action='jsps/useconditionalforward.jsp' method='get'>");
