...
public class SessionTrackingURLRewritingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SessionTrackingURLRewritingServlet() {
        super();        
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		bodyBuffer.append(GlobalHTMLTags.doAppendHeading("5", "Servlet Cookie JSESSIONID: " + sessionID));
		bodyBuffer.append("<a href=\""+ response.encodeURL("DisplayJSessionIdServlet") +"\">");
		bodyBuffer.append("View JSessionID </a>");
