...
public class URLMappingServletThree extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public URLMappingServletThree() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			bodyBuffer.append(GlobalHTMLTags.doAppendHeading("4", "URLMappingServletThree is selected"));
