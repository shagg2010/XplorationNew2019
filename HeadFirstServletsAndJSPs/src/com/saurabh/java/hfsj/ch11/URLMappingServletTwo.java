...
public class URLMappingServletTwo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public URLMappingServletTwo() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			bodyBuffer.append(GlobalHTMLTags.doAppendHeading("4", "URLMappingServletTwo is selected"));
