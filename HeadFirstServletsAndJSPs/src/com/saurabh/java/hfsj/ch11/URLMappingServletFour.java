...
public class URLMappingServletFour extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public URLMappingServletFour() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			bodyBuffer.append(GlobalHTMLTags.doAppendHeading("4", "URLMappingServletFour is selected"));
