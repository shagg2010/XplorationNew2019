...
public class GetUserInfoViaServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public GetUserInfoViaServlet2() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			bodyBuffer.append("<form action='jsps/customtagsintro.jsp' method='get'>");
			...
			htmlPageBuffer.append(GlobalHTMLTags.doStartHTMLBody("Chapter 9 - Introduction to Custom Tags", "resources/cssstyle.css" , bodyBuffer));
